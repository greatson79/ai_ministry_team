...
PARENT_ROOT = os.path.expanduser(os.environ.get("CHURCHTEAM_PARENT_ROOT", "~/AgenticWorkflow-Template"))  # 선택: 부모 게놈 경로
ENVSCAN_ROOT = os.path.expanduser(os.environ.get("CHURCHTEAM_ENVSCAN_ROOT", ""))  # 선택: 환경스캐닝 시스템 경로(미설정 시 스킵)
